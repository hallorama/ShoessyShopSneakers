...
<body>
            ...
            <div class="box">
                <form action="" method="POST" enctype="multipart/form-data">
                    <select name="kategori" class="input-control">
                        ...
                        ?>
                        <option value="<?php echo $r['category1_id'] ?>" <?php echo ($r['category1_id'] == $p->category_id)?'selected':''; ?>><?php echo $r['category1_name'] ?></option>
                        <?php } ?>
                    </select>
    ...
    <script>
        ClassicEditor
            .create( document.querySelector( '[name="deskripsi"]' ) )
            .then( editor => {
                    console.log( editor );
            } )
            .catch( error => {
